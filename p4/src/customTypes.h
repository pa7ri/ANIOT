 ...
 * Config driver i2c
 */
#define I2C_MASTER_NUM 1                                    // select 0 or 1 availables
...
#define I2C_MASTER_FREQ_HZ 400000                           // I2C master clock frequency. Max 1MHz
...
#define SI7021_CMD_START 0xF3                               // Start measure temp for Si7021 sensor. Measure Temperature, Hold Master Mode 0xF3 - page 18
